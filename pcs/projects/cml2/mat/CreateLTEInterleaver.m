function Pattern = CreateLTEInterleaver(DataLength)
% This function creates an interleaver according to the UMTS-LTE specifications.
    ...
    % Finding DataLength in the first column of UMTSLTE_Table
    Index = find( UMTSLTE_Table(:,1) == DataLength );
    if ( length(Index) ~= 1 )
    ...
    F1 = UMTSLTE_Table( Index, 2 );
    F2 = UMTSLTE_Table( Index, 3 );
    ...
    for i=0:DataLength-1
        ...
        Pattern(i+1) = mod( F1*i+F2*i*i, DataLength );
    end
end