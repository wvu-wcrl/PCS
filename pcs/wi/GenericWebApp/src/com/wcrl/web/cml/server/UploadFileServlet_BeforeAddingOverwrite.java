...
import com.wcrl.web.cml.client.account.User;
 ...
 public class UploadFileServlet_BeforeAddingOverwrite extends HttpServlet {
	 ...
	 public UploadFileServlet_BeforeAddingOverwrite()
	 {
		 super();
	 }
                 ...
                 try 
                 {
                     ...
                     for (FileItem item : items) 
                     {
                         ...
                         if (fileName != null) 
                         {
                    		 ...
                    		 {
                    			 fileFlag = false;
                    			 String msg = "0~Not a valid file format.";
                     ...
                     if(fileFlag)
                     {
                    	 ...
                    	 {
                    		 String msg = 0 + "~You have exceeded your usage quota. Please contact administrator.";
            				 response.getWriter().print(msg);
     ...
     private void createNewFile(String dir, String fileName, FileItem item, HttpServletResponse response)
     {
         ...
         if(success)
         {
             ...
             try 
             {
            	 if(fileExists)
            	 {
            		 String msg = 0 + "~Job with the file name already exists in the repository. Do you want to overwrite?";
    				 response.getWriter().print(msg);
    			     //throw new IOException(msg); 
            	 }
            	 else
