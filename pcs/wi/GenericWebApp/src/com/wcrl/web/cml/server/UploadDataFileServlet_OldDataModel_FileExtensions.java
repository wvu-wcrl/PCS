...
import com.allen_sauer.gwt.log.client.Log;
 ...
 public class UploadDataFileServlet_OldDataModel_FileExtensions extends HttpServlet {
	 ...
	 public UploadDataFileServlet_OldDataModel_FileExtensions()
	 {
		 super();
	 }
         ...
         if(success)
         {
        	 ...
        	 try
        	 {
        		 if(fileExists)
            	 {
                	 ...
                	 {
            			 String msg = 0 + "~Data file with the name already exists in the repository. Do you want to overwrite?";
            			 response.getWriter().print(msg);
                	 }
                	 else
                	 {
