				...
				if (place instanceof AnimationPlace) {
					...
					if (place instanceof UIPlace) {
						...
						if (place instanceof UIPlace) {
							...
							if (place instanceof UploadImagesPlace||place instanceof AboutPlace ||place instanceof ButtonBarPlace || place instanceof GroupedCellListPlace || place instanceof CarouselPlace || place instanceof ButtonPlace
				...
				if (place instanceof AnimationPlace) {
					...
					if (place instanceof UIPlace) {
						...
						if (place instanceof UIPlace) {
							...
							if (place instanceof ButtonBarPlace || place instanceof UploadImagesPlace ||place instanceof GroupedCellListPlace || place instanceof CarouselPlace || place instanceof ButtonPlace
									|| place instanceof AboutPlace||place instanceof ElementsPlace || place instanceof FormsPlace || place instanceof PopupPlace || place instanceof ProgressBarPlace
									|| place instanceof ProgressIndicatorPlace || place instanceof PullToRefreshPlace || place instanceof ScrollWidgetPlace || place instanceof SearchBoxPlace
									|| place instanceof SliderPlace || place instanceof TabBarPlace) {
							//	historyHandler.replaceCurrentPlace(new HomePlace());
