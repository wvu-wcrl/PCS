...
public class PhoneAnimationMapper implements AnimationMapper {
	...
	/*	if (oldPlace instanceof UIPlace && newPlace instanceof HomePlace) {
		...
		if (oldPlace instanceof UploadImagesPlace && newPlace instanceof HomePlace) {
			return Animations.SLIDE_REVERSE;
		}
		...
		if (oldPlace instanceof AboutPlace && newPlace instanceof UploadImagesPlace) {
			return Animations.SLIDE;
		}
		if (oldPlace instanceof UploadImagesPlace && newPlace instanceof AboutPlace) {
			return Animations.SLIDE_REVERSE;
		}
