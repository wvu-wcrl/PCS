...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "showcase" because\n';
  ...
  $wnd.__gwt_activeModules['showcase'] = {
    'moduleName' : 'showcase',
    'bindings' : function() {
      return {};
    }
 ...
 * "/showcase.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['showcase'].superdevmode = true;

  var expectedSuffix = '/showcase.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + showcase + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:showcase';
  var devModeSessionKey = '__gwtDevModeSession:showcase';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/showcase/showcase.nocache.js';
  ...
  $wnd.__gwt_activeModules['showcase'].canRedirect = true;
  $wnd.__gwt_activeModules['showcase'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/showcase?user.agent=' + ua + '&_callback=' + callback;
