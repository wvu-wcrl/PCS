...
public class AddProject_BeforeAddingPossiblyRequiresDataFile extends Composite{
	
	private VerticalPanel vPanel = new VerticalPanel();
	private Label lblMsg = new Label();
	private FlexTable table;	
	private TextBox txtProject = new TextBox();
	private TextBox txtDirectoryPath = new TextBox();
	...
	public AddProject_BeforeAddingPossiblyRequiresDataFile()
	{
