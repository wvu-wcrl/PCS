CREATE DATABASE  IF NOT EXISTS `MFaceRecdb` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `MFaceRecdb`;
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.6 (i386)
--
-- Host: 127.0.0.1    Database: MFaceRecdb
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `MasterKey`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MasterKey` (
  `Id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique Identifier',
  `HashKey` varchar(150) NOT NULL COMMENT 'Key to generate Model for Identification',
  `CreatedAt` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `UpdatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `UserId` bigint(20) NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 COMMENT='MasterKey preference table';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1 COMMENT='File extensions valid for the input data files.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userreg` (
  ...
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=latin1 COMMENT='User preference table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'facerecdb'
--
/*!50003 DROP PROCEDURE IF EXISTS `ADDMASTERKEY` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ADDMASTERKEY`(IN MASTERKEY VARCHAR(150), IN USERNAME VARCHAR(150))
BEGIN
  DECLARE USERID INT;
  SET USERID = 0;

  SELECT USERREG.USERID INTO USERID FROM USERREG WHERE USERREG.USERNAME = USERNAME;	
  INSERT INTO MASTERKEY(HASHKEY, CREATEDAT, UPDATEDAT, USERID) VALUES(MASTERKEY, NULL, NULL, USERID);
END ;;
DELIMITER ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ADDPROJECT`(IN PROJECTNAME VARCHAR(255), IN DESCRIPTION VARCHAR(255), 
                                                        IN PATH VARCHAR(255),
                                                        IN DATAFILE INT(11),
                                                        OUT FLAG INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ADDUSER`(IN USERNAME VARCHAR(150), IN PASSWORD VARCHAR(255), IN EMAIL VARCHAR(150), IN USERTYPE VARCHAR(32), OUT FLAG INT)
BEGIN
  DECLARE CNT INT;
  DECLARE USERID INT;
  SET CNT = 0;
  ...
  IF (CNT = 0) THEN
    INSERT INTO USERREG(USERNAME, PASSWORD, USERTYPE, PRIMARYEMAIL, CREATEDAT, UPDATEDAT) VALUES(USERNAME, PASSWORD, USERTYPE, EMAIL, NULL, NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ADDUSERDATAFILE`(IN userid varchar(150),
                                                         IN name varchar(25),
                                                         IN notes BLOB,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETEPROJECT`(IN PROJECT_ID INT, OUT FLAG INT)
BEGIN
SET FLAG = 0;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETEUSER`(IN USERID INT, OUT FLAG INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DISABLEUSER`(IN USERID INT, OUT FLAG INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITPASSWORD`(IN USERID INT, IN PASSWORD varchar(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETDATAFILEEXTENSIONS`(IN PROJECT VARCHAR(255))
BEGIN
    DECLARE PROJECTID INT;
    SET PROJECTID = 0;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETJOBFILEEXTENSIONS`(IN PROJECT VARCHAR(255))
BEGIN
    DECLARE PROJECTID INT;
    SET PROJECTID = 0;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GETMASTERKEY` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETMASTERKEY`(OUT HASHKEY VARCHAR(150))
BEGIN
	
  SELECT MASTERKEY.HASHKEY INTO HASHKEY FROM MASTERKEY ORDER BY MASTERKEY.CREATEDAT DESC LIMIT 1;	
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETPREFERREDPROJECT`(IN USERID BIGINT(20))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETUSERDATAPROJECTS`(IN USERID INT)
BEGIN
    IF (USERID = 0) THEN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETUSERPROJECTS`(IN USERID INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GETUSERSTATUS`(IN USERID BIGINT(20), OUT USERSTATUS INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTERUSER`(IN USERNAME VARCHAR(150), IN PASSWORD VARCHAR(255), IN FIRSTNAME VARCHAR(150), IN LASTNAME VARCHAR(150), IN EMAIL VARCHAR(150), IN USERTYPE VARCHAR(32), IN STATUS INT, IN TOTALUNITS DOUBLE, IN NEWSLETTER INT, OUT FLAG INT)
BEGIN
  DECLARE CNT INT;
  DECLARE USERID INT;
  SET CNT = 0;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SAVEUSERPROJECT`(IN USERID INT, IN PROJECTID INT, IN PREFERREDPROJECT INT)
BEGIN
  DECLARE CNT INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UNSUBSCRIBEUSERPROJECT`(IN USERID INT, IN PROJECTID INT)
BEGIN
  DECLARE CNT INT;
  SET CNT = 0;
  SELECT COUNT(PROJECTID) INTO CNT FROM USERPROJECTS U WHERE U.USERID = USERID AND U.PROJECTID = PROJECTID;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATECOUNTRY`(IN USERID INT, IN COUNTRY VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEEMAIL`(IN USERID INT, IN EMAIL varchar(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEFIRSTNAME`(IN USERID INT, IN FIRSTNAME VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEJOBTITLE`(IN USERID INT, IN JOBTITLE VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATELASTNAME`(IN USERID INT, IN LASTNAME VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATENEWSLETTERSUBSCRIPTION`(IN USERID INT, IN SUBSCRIPTION INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEORGANIZATION`(IN USERID INT, IN ORGANIZATION VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEPROJECTDATAFILE`(IN PROJECTID INT, IN REQUIREDFLAG INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEPROJECTDESCRIPTION`(IN PROJECTID INT, IN DESCRIPTION VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEPROJECTNAME`(IN PROJECTID INT, IN PROJECTNAME VARCHAR(255), OUT TEMP INT)
BEGIN
SET TEMP = -1;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEPROJECTPATH`(IN PROJECTID INT, IN PATH VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEUSERQUOTA`(IN USERID INT, IN ADDQUOTA DOUBLE, OUT TOTALQUOTA DOUBLE, OUT USEDUNITS DOUBLE)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEUSERSTATUS`(IN USERID INT, IN STATUS INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATEUSERUSAGE`(IN USERNAME VARCHAR(255), IN USED_UNITS DOUBLE, IN PROJECTNAME VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USERUSAGE`(IN USERID INT, OUT USEDUNITS DOUBLE)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `VALIDATEUSER`(IN USERNAME VARCHAR(150))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `VALIDATEUSEREMAIL`(IN EMAIL VARCHAR(150), OUT CNT INT)
BEGIN
...
-- Dump completed on 2013-10-28 16:03:37
