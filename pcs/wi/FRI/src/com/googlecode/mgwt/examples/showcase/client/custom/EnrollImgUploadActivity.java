 ...
 * 
 */
public class EnrollImgUploadActivity extends DetailActivity {

	private final ClientFactory clientFactory;

	public EnrollImgUploadActivity(ClientFactory clientFactory) {
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		...
		EnrollImgUploadView view = clientFactory.getEnrollImgUploadView(clientFactory);
