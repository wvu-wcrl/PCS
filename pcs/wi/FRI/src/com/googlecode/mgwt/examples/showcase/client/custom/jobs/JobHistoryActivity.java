 ...
 * 
 */
public class JobHistoryActivity extends DetailActivity {

	private final ClientFactory clientFactory;

	public JobHistoryActivity(ClientFactory clientFactory) {
		super(clientFactory.getJobHistoryView(clientFactory), "nav");
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		...
		JobHistoryView view = clientFactory.getJobHistoryView(clientFactory);
		...
		addHandlerRegistration(view.getBackbutton().addTapHandler(new TapHandler() {
		      ...
		      public void onTap(TapEvent event) {
		    	  ...
		    	  //clientFactory.getBcFunctionbuttonView(clientFactory);
