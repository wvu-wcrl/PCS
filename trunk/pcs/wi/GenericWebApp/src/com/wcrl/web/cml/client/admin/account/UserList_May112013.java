...
public class UserList_May112013 extends Composite implements ClickHandler
{
	...
	{		
		...
		if(sender == btnDisable)
		{
			...
			{
				if(Window.confirm("Are you sure to disable selected users?"))
				{
