 ...
 * 
 */
public class IdentifyImgUploadActivity extends DetailActivity {

	private final ClientFactory clientFactory;

	public IdentifyImgUploadActivity(ClientFactory clientFactory) {
		super(clientFactory.getIdentifyImgUploadView(clientFactory), "nav");
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		...
		IdentifyImgUploadView view = clientFactory.getIdentifyImgUploadView(clientFactory);
