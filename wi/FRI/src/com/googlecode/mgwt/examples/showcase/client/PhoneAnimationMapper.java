...
public class PhoneAnimationMapper implements AnimationMapper {
	...
	public Animation getAnimation(Place oldPlace, Place newPlace) {
		...
		{
			System.out.println("Old: " + oldPlace.getClass() + " New: " + newPlace.getClass());			
		}
		*/
		...
		if (oldPlace instanceof ElementsPlace && newPlace instanceof BCFunctionButtonPlace) {
			return Animation.SLIDE;
		}
		
		if (oldPlace instanceof BCFunctionButtonPlace && newPlace instanceof ElementsPlace) {
			return Animation.SLIDE_REVERSE;
		}
		
		if (oldPlace instanceof BCFunctionButtonPlace && newPlace instanceof EnrollImgUploadPlace) {
			return Animation.SLIDE;
		}
		
		if (oldPlace instanceof EnrollImgUploadPlace && newPlace instanceof BCFunctionButtonPlace) {
			return Animation.SLIDE_REVERSE;
		}
		
		/*if (oldPlace instanceof BCFunctionButtonPlace && newPlace instanceof ChangePasswordPlace) {
			return Animation.SWAP;
		}
		
		if (oldPlace instanceof ChangePasswordPlace && newPlace instanceof BCFunctionButtonPlace) {
			return Animation.SWAP_REVERSE;
		}
		
		if (oldPlace instanceof EnrollImgUploadPlace && newPlace instanceof ChangePasswordPlace) {
			return Animation.SWAP;
		}
		
		if (oldPlace instanceof ChangePasswordPlace && newPlace instanceof EnrollImgUploadPlace) {
			return Animation.SWAP_REVERSE;
		}*/
		...
		if (oldPlace instanceof AnimationPlace && newPlace instanceof AnimationSlideDownPlace) {
			return Animation.SLIDE_UP_REVERSE;
		}

		if (oldPlace instanceof AnimationSlideDownPlace && newPlace instanceof AnimationPlace) {
			return Animation.SLIDE_UP;
		}
