...
import com.jmatio.types.MLStructure;
 ...
 public class GenerateJobServlet_Oct252013_BeforeCallingMatlabSciptsToAvoidSavingKey extends HttpServlet {
	 ...
	 public GenerateJobServlet_Oct252013_BeforeCallingMatlabSciptsToAvoidSavingKey()
	 {
		 super();
	 }
                 ...
                 try 
                 {
                     ...
                     try
                     {
                         ...
                         if(!jobFileFlag)
                         {
                             ...
                             boolean fileGenerated = generateJobFile(jobFile, dataFileName);
                             String jobMsg = "";
                             if(fileGenerated)
                             {
     ...
     private boolean generateJobFile(File jobFile, String dataFileName)
     {
    	 ...
    	 try 
    	 {
    		 ...
    		 else if(jobDetailsMap.get("taskName").equalsIgnoreCase("Identification"))
    		 {
    			 ...
    			 String hashKey = keyImpl.getHashKey();
    		 ...
    		 else if(jobDetailsMap.get("taskName").equalsIgnoreCase("Verification"))
    		 {
    			 ...
    			 String userProvidedHashKey = BCrypt.hashpw(secretKey, BCrypt.gensalt(12));
    			 
    			 System.out.println("dataName: " + dataName + " secretKey:" + secretKey + " classID: " + classID + " taskName: " + taskName);
    			     			 
    			 MLChar testDataFileName = new MLChar("DataFile", dataName);
    			 MLChar key = new MLChar("Key", userProvidedHashKey);
 			...
 			{
 				MasterKeyImpl keyImpl = new MasterKeyImpl();
 				keyImpl.addHashKeyToDB(masterHashKey, jobDetailsMap.get("user"));
 			}
