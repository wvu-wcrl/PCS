...
import com.googlecode.mgwt.examples.showcase.client.activities.Upload.UploadImagesView;
import com.googlecode.mgwt.examples.showcase.client.activities.Upload.UploadImagesViewGwtImpl;
...
//	private AboutView homeViewImpl;
	//private ShowCaseListView showcaseListView; 
	...
	//	homeViewImpl = new AboutViewGwtImpl(ClientFactory clientFactory);
	}
	...
	//@Override
	//public AboutView getHomeView() {
	//	if (homeViewImpl == null) {
	//		homeViewImpl = new AboutViewGwtImpl();
	//	}
	//	return homeViewImpl;
	//} 
	...
	// Added for aTesting
	/*@Override
	public ShowCaseListView getShowCaseListView() {
		if (showcaseListView == null) {
			showcaseListView = new ShowCaseListViewGwtImpl();
		}
	...
	@Override
	public AboutView getAboutView(ClientFactory clientFactory) {
	//	if (aboutView == null) {
			aboutView = new AboutViewGwtImpl(clientFactory);
	//	}
	...
	@Override
	public UploadImagesView getUploadImagesView(ClientFactory clientFactory) {
	//	if (uploadimagesView == null) {
			uploadimagesView = new UploadImagesViewGwtImpl(clientFactory);
		//}
