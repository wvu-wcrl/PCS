...
import com.wcrl.web.cml.client.account.User;
 ...
 public class UploadJobandDataFileServlet_Original extends HttpServlet {
	 ...
	 public UploadJobandDataFileServlet_Original()
	 {
		 super();
	 }
    ...
    {   		 
    	 ...
    	 if (session.getAttribute("Username") != null)
    	 {
             ...
             {            
                 ...
                 try 
                 {
                     ...
                     System.out.println("jobFileFlag: " + jobFileFlag +  " dataFileFlag: " + dataFileFlag);
                     if(!jobFileFlag && !dataFileFlag)
                     {
                    	 ...
                    	 for(Entry<String, FileItem> entry : entries)
                    	 {
                    		 ...
                    		 if(key.equals("jobUpload"))
                    		 {
                    			 ...
                    			 String dataFile = getJobEmbeddedDataFileName(uploadedFile);
                    		 }
                     ...
                     {
                    	 String msg = "0~Chosen files exist in the repository. Do you want to overwrite?";
                    	 response.getWriter().print(msg);                    	 
                     }
                     /*if(jobFileFlag)
                     {
     ...
     private String getJobEmbeddedDataFileName(File jobFile)
     {
    	 String dataFileName = "";
    	 try 
    	 {
			...
			{				
				...
				MLArray dataFileField = null;
				if(mlParamStructure.getField("DataFile") != null)
				{
					dataFileField = mlParamStructure.getField("DataFile");
					System.out.println("Data filename: " + dataFileField.contentToString());
				}				
			}
    	 } 
    	 catch (IOException e) 
