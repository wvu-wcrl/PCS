...
import com.wcrl.web.cml.client.account.User;
 ...
 public class UploadFileServlet_SavingToTmpDir extends HttpServlet {
	 ...
	 public UploadFileServlet_SavingToTmpDir()
	 {
		 super();
	 }
    ...
    {   		 
        	 ...
        	 try
        	 {
        		 if(fileExists)
            	 {
                	 ...
                	 else
                	 {
                		 ...
                		 removeFile.delete();        
                		 createFile(uploadedFile, item, response, dir);  
                	 }            		 
            	 }
            	 else
            	 {
     ...
     public synchronized void createFile(File uploadedFile, FileItem item, HttpServletResponse response, String dir)
     {
    	 try 
         {
    		 String tomcatWebAppTempDir = constants.getString("TomcatWebAppJobsTempDir");
    		 String fileName = uploadedFile.getName();
    		 String tempDirPath = tomcatWebAppTempDir + fileName;
    		 File tempFileUploadDir = new File(tomcatWebAppTempDir);
