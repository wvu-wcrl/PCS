...
{	
	...
	public JobItem(int jobId, int userId, String username, String jobName, String jobDescription, Date jobUploadTime, int progress, String status, String jobNotes, boolean outputFileExists, int numberOfInputFiles, int numberOfOutputFiles, Map<Integer, String[]> inputFiles, Map<Integer, String[]> outputFiles)
	{
		this.jobId = jobId;
		this.userId = userId;
