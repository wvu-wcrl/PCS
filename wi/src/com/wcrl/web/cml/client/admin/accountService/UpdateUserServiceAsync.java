...
{	
	public void updateUserStatus(int userId, int newStatus, int currentStatus, String username, String primaryEmail, AsyncCallback<Integer> updateUserStatusCallback);
	...
	public void updateNewsletterSubscription(int userId, int subscription, AsyncCallback<Integer> updateUserNewsletterSubscriptionCallback);
}
